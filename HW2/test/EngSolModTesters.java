...
public class EngSolModTesters {
  ...
  public void testInvalidArmTConstruct() {
    ...
    try {
      ...
      // Given a negative and even. Arm thickness must be a positive, odd number
    } catch (IllegalArgumentException e) {
    ...
    try {
      ...
      // "Given a negative and odd. Arm thickness must be a positive, odd number
    } catch (IllegalArgumentException e) {
      System.out.println("Caught exception" + e);
    }
    ...
    try {
      ...
      // Given a positive and even. Arm thickness must be a positive, odd number.
    } catch (IllegalArgumentException e) {
      System.out.println("Caught exception" + e);
    }
  }
  ...
  public void testMoveValid() {
    ...
    // One constructor
    armModel = new EnglishSolitaireModel(3);
    armModel.move(3, 5, 3, 3);

    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            armModel.getSlotAt(3, 5));
    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            armModel.getSlotAt(3, 4));
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            armModel.getSlotAt(3, 3));

    // Two parameter constructor
    rowColModel = new EnglishSolitaireModel(3, 2);
    rowColModel.move(3, 1, 3, 3);

    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            rowColModel.getSlotAt(3, 1));
    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            rowColModel.getSlotAt(3, 2));
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            rowColModel.getSlotAt(3, 3));

    // Three parameter model
    armRowColModel = new EnglishSolitaireModel(3, 4, 2);
    armRowColModel.move(3, 1, 3, 3);

    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            armRowColModel.getSlotAt(3, 1));
    assertEquals(MarbleSolitaireModelState.SlotState.Empty,
            armRowColModel.getSlotAt(3, 2));
    assertEquals(MarbleSolitaireModelState.SlotState.Marble,
            armRowColModel.getSlotAt(3, 3));
  ...
  public void testIsNotValid() {
    // Set up a board with no valid moves
    try {
      armRowColModel = new EnglishSolitaireModel(1, 0, 0);
    } catch (IllegalArgumentException e) {
      System.out.println("Caught exception:" + e);
    }
  }
  ...
  public void testGetScore() {
    ...
    assertEquals(160, bSizeTest.getScore());
  }

  // To test getBoardSize
  @Test
  public void testGetBoardSize() {
    assertEquals(15, bSizeTest.getBoardSize());
  ...
  public void testGetSlotAt() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Marble, armRowColModel.getSlotAt(4, 4));
  }
